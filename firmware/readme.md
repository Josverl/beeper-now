...
ESP32-C3 documentation: https://docs.espressif.com/projects/esp-idf/en/latest/esp32c3/api-reference/system/sleep_modes.html#gpio-wakeup


# esp32: Add esp32.wake_on_gpio.

Wake-up can be triggered by  : 
- a LOW signal (button press pulling the pin to ground).
- a HIGH signal (button press pulling the pin to 3.3v).  ( Either of multiple pins  in the range 0 to 5.)
